function obtenerRutaImagen(nombreProducto) {
  // Convertir a minúsculas, quitar tildes, eñes y reemplazar espacios por guiones
  let nombreArchivo =
    nombreProducto
      .toLowerCase()
  ...
  // Construir la ruta absoluta compatible con GitHub Pages
...
function renderizarProductos() {
  ...
  for (let i = contadorA; i < contadorB; i++) {
    ...
    const rutaImagen = obtenerRutaImagen(producto.nombre);
    if (producto) {
      productos.innerHTML += `
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img class="rounded-t-lg" src="${rutaImagen}" alt="${producto.nombre}" />
          </a>
          <div class="p-5">
            <a href="#">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">¡A solo $${producto.precio}!</p>
